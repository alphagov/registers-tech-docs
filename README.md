...
Unless stated otherwise, the codebase is released under the [MIT License](https://github.com/bahmady/registers-tech-docs/blob/master/LICENSE). This covers both the codebase and any sample code in the documentation.
